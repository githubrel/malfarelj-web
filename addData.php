...
<head>
    ...
    <title>Tambah Data | WEB PANGKALAN DATA MAHASISWA</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">WEB PANGKALAN DATA MAHASISWA</a>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2">
                ...
                <p>TUGAS WEB PROGRAMING MUHAMAD ALFAREL JULIANTO 2211476440!</p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                <h4 class="fw-bold text-uppercase">Account Links</h4>
                <a href="https://web.facebook.com/malfarelj/" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://github.com/malfarelj" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/malfarelj_/" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://twitter.com/malfarelj" target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://www.instagram.com/malfarelj_/" target="_blank" style="color: #fff;">muhamad alfarel julianto</a></p>
    </footer>
    <!-- Close Footer -->
