...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">WEB DATA CURD</a>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="sistem informasi" <?php if ($siswa['jurusan'] == 'sistem informasi') { ?> selected='' <?php } ?>>sistem informasi</option>
                            ...
                            <option value="ekonomi dan bisnim" <?php if ($siswa['jurusan'] == 'ekonomi dan bisnim') { ?> selected='' <?php } ?>>ekonomi dan bisnim</option>
                        </select>
                    </div>
                    <div class="mb-3">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2">
                ...
                <p>TUGAS WEB PROGRAMING | MUHAMAD ALFARELJ JULIANTO 2211476440</p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                <h4 class="fw-bold text-uppercase">Account Links</h4>
                <a href="https://web.facebook.com/muhamad alfarel julianto/" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://github.com/malfarelj" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/malfarelj/" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://twitter.com/malfarelj" target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="https://instagram.com/malfarelj" target="_blank" style="color: #fff;">Vikry Surya P</a></p>
    </footer>
    <!-- Close Footer -->
