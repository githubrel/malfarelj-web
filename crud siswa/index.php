...
<head>
    ...
    <title>WEB PANGKALAN DATA MAHASISWA</title>
</head>
...
<body>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">muhamad alfarel julianto</u></p>
    </footer>
    <!-- Close Footer -->
